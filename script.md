...
But honestly, this wasn't just a Tower problem. Rust and the ecosystem was still young. We were all figuring out how to design libraries in this language.



  "But honestly, this wasn't just a Tower problem. Rust was still young. We were all
  figuring out how to design libraries in this language. The patterns hadn't crystallized
  yet — we were reaching for things that worked in other languages and learning the hard
  way that Rust needed its own approach."
